...
function NavBar() {
  ...
  return (
    <>
      <div className="sticky top-0 left-0 bg-red-500 shadow p-4 mb-4">
        <div className="container mx-auto flex flex-col gap-2 lg:gap-0 lg:flex-row justify-between items-center">
          ...
          <div className="flex items-center justify-center flex-wrap space-x-2 lg:space-x-6">
            {categoryData.map((item, index) => (
              <button
                ...
                className="text-white font-bold hover:scale-[1.1]"
              >
                {item}
              </button>
            ))}
          ...
          <form onSubmit={handleSearch} className="flex items-center">
            ...
            />
            <div className="bg-white text-gray-400 py-1 px-2 rounded-lg rounded-s-none border border-gray-300 cursor-pointer hover:scale-[1.1]" onClick={handleSearch}>
